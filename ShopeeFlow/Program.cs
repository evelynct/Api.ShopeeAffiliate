...
builder.Services
    .AddOptions<CollectSettings>()
    .Bind(builder.Configuration.GetSection(CollectSettings.SectionName));
...
builder.Services.AddHostedService<ProductCollectBackgroundService>();
